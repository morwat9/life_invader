          ...
          <div className={styles["home-container"]}>
            <div className={styles["greeting"]}>
              <div className={styles["brand"]}>
                <p className={shareTechMono.className}>list_foundation</p>
              </div>
              <div className={styles["greeting-message"]}>
                <p className={firaSans.className}>
                  Classified advertisements with sections devoted to jobs, housing, sales, and much more.
                </p>
              </div>
            </div>
